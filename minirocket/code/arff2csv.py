...
if __name__ == "__main__":
    ...
    train_path = os.path.join(dataset_path, "ucr_archive/InsectSound/InsectSound_TRAIN.arff")
    test_path = os.path.join(dataset_path, "ucr_archive/InsectSound/InsectSound_TEST.arff")
    csv_train_path = os.path.join(dataset_path, "ucr_archive/InsectSound/InsectSound_TRAIN.csv")
    csv_test_path = os.path.join(dataset_path, "ucr_archive/InsectSound/InsectSound_TEST.csv")
